...
class My_wxfollowApp extends StoreadminbaseApp {
    ...
    function index() {
        ...
        /* 当前位置 */
        $this->_curlocal(LANG::get('member_center'), 'index.php?app=member', LANG::get('my_wxfollow'));

        /* 当前用户中心菜单 */
        $this->_curitem('my_wxfollow');

        /* 当前所处子菜单 */
        $this->_curmenu('all_keyname');
        $this->_config_seo('title', Lang::get('member_center') . ' - ' . Lang::get('my_wxfollow'));
