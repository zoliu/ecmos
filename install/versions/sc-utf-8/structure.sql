...
MySQL - 5.5.46-log : Database - ecm_360cd
*********************************************************************
*/
...
CREATE TABLE `ecm_member` (
  ...
  `grade_id` int(10) unsigned NOT NULL COMMENT '用户等级',
  `parent_id` bigint(20) unsigned NOT NULL COMMENT '直接上级用户',
  `parent_path` varchar(2000) NOT NULL DEFAULT ',0' COMMENT '所有上级用户',
  `total_buy` bigint(20) unsigned NOT NULL DEFAULT '0' COMMENT '累计购物',
  `total_sell` bigint(20) unsigned NOT NULL DEFAULT '0' COMMENT '累计销售',
...
/*Table structure for table `ecm_member_level` */

DROP TABLE IF EXISTS `ecm_member_level`;

CREATE TABLE `ecm_member_level` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
