...
class Dir
{
     ...
     */
    public function get_dir_filename($path, $remove_path = '')
    {
        $file_list = array();
     ...
     * @param string $path
     */
    public function del_empty_dir($path)
    {
...
class Methods
{
     ...
     *            是否计算时区，默认启用
     */
    public static function get_day_timestamp($timestamp, $zone = true)
    {
     ...
     *            是否计算时区，默认启用
     */
    public static function get_week_timestamp($timestamp, $zone = true)
    {
        $timezone = $zone ? date('Z') : 0;
     ...
     * @return array
     */
    public static function save_config($filename, $data)
    {
     ...
     * @return mixed
     */
    public static function load_config($filename, $key = '')
    {
     ...
     * @return string
     */
    public static function get_guid($glue = '')
    {
     ...
     * @return string|mixed
     */
    public static function url($url = '', $name = '', $value = '', $del = false)
    {
        if ($url == '') {
     ...
     * @param array $param
     */
    public static function curl($url, $action = 'GET', $param = array(), $decode = true)
    {
